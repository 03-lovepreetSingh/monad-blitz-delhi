  ...
  const chatMessages = messages.filter(
    (msg) =>
      (msg.from === (session?.user as any)?.username &&
        msg.to === activeChatUser) ||
      (msg.to === (session?.user as any)?.username &&
        msg.from === activeChatUser)
  );
    ...
    <>
      ...
      {isOpen && (
        <div className="fixed bottom-20 right-4 w-full max-w-md z-40 animate-fade-in-up">
          <div className="chat-container p-4 bg-neutral-900 rounded-lg shadow-lg">
            ...
            {!activeChatUser ? (
              // User selection view
              <div className="messages bg-neutral-800 text-neutral-100 space-y-2 mb-4 h-64 overMonad-y-auto p-3 rounded-lg">
                ...
                <div className="my-1">
                  {filteredUsers.map((user: any) => (
                    <div
                      ...
                      className="flex justify-between items-center py-2 px-3 my-1 rounded-lg hover:bg-neutral-700 transition-colors cursor-pointer"
                    >
            ...
            {activeChatUser && (
              <div className="message-input flex gap-2">
                <input
                  ...
                  className="flex-1 p-2 border border-neutral-600 rounded bg-neutral-700 text-white focus:outline-none focus:ring-1 focus:ring-blue-500"
