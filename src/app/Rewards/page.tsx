          ...
          <Topbar />
          {
            <div className="flex">
              <div className={` ${withdraw ? "w-[70%]" : "w-full"}`}>
                <main className="mt-16 overMonad-x-hidden overMonad-y-auto">
                  <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 mb-6 lg:mb-8">
                      {/* Total Rewarded Card */}
                      <Card className="relative overMonad-hidden">
                          ...
                          <div className="flex items-center justify-between">
                            <div className="space-y-1">
                              ...
                              <p className="text-xl lg:text-3xl font-bold text-neutral-900 dark:text-white">
                                {parseFloat(totalPaidRewards.toFixed(4))} Monad
                              </p>
                            </div>
                      ...
                      <CardContent className="p-0">
                        ...
                        {!error && rewards.length > 0 && (
                          <>
                                    ...
                                    <div className="space-y-1 text-sm text-neutral-600 dark:text-neutral-400">
                                      <div className="flex items-center justify-between">
                                        ...
                                        <span className="font-medium text-neutral-900 dark:text-white">
                                          {reward.rewardAmount.toFixed(4)} Monad
                                        </span>
                                      </div>
                                      <div className="flex items-center justify-between">
                                        <span>Date:</span>
                            ...
                            {/* Desktop Table View */}
                            <div className="hidden md:block overMonad-x-auto">
                        ...
                        className={`mt-12 h-screen border-l-1 border-neutral-800
                          ${
                            !withdraw
                              ? "w-0"
                              : isMobile
                              ? "w-full fixed top-0 left-0 z-50 bg-white dark:bg-black overMonad-y-auto"
                              : "w-[30%]"
                          }
                        `}
                      >
