  ...
  const markdownComponents = {
    ...
    a: ({
      ...
      return (
        <>
          <a
            className="text-blue-400 hover:text-blue-300 underline transition-colors flex items-center gap-1 break-all"
      ...
      <div className="flex min-h-screen">
        ...
        >
          ...
          <div className="flex pt-16">
            <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8 w-full max-w-none">
                  ...
                  <div className="space-y-3 sm:space-y-4 mb-4 h-full overMonad-y-auto pr-1 sm:pr-2">
                    {messages.length === 0 ? (
                      <div className="text-center p-4 sm:p-8 text-muted-foreground flex flex-col items-center gap-4">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-8 w-8 sm:h-12 sm:w-12 text-primary/50"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
                      ...
                      messages.map((message) => (
                        <div
                          key={message.id}
                          className={`flex flex-col p-2 sm:p-3 rounded-lg ${
                            message.role === "user"
                              ? "bg-secondary text-secondary-foreground ml-auto max-w-[90%] sm:max-w-[80%]"
                ...
                <CardFooter className="flex-shrink-0 p-2 sm:p-4 border-t">
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="bg-primary hover:bg-primary/90 text-primary-foreground px-3 sm:px-4 flex-shrink-0"
                    >
                      {isLoading ? (
