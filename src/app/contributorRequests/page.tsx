...
export default function PullRequestsPage({ repo_name }: { repo_name: string }) {
  ...
  const username = useMemo(
    () => (session?.user as User)?.username as session,
    [session?.user]
  );
      ...
      <div className="">
        <div className="w-[calc(100%)]">
          <div className="p-4 sm:p-6 lg:p-8  w-full mx-auto">
            ...
            <div className="text-sm sm:text-base text-neutral-600 dark:text-neutral-400 mt-2">
                        ...
                        >
                          ...
                          <div className="flex items-center justify-end gap-2">
                            <button
                              ...
                              className="text-green-500 hover:bg-violet-50 dark:hover:bg-violet-900 rounded-full p-2"
                            >
                              <svg
                                width="18"
                                height="18"
                          ...
                          {repoData.map((req) => (
                            ...
                            >
                              ...
                              <td className="px-4 py-3 flex items-center gap-2">
                                <button
                                  onClick={() => handleApprove(req)}
                                  className="text-green-500 hover:bg-violet-50 dark:hover:bg-violet-900 rounded-full p-1"
                                >
                                  <svg
                                    width="18"
                                    height="18"
