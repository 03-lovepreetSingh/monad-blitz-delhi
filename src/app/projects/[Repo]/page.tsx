...
export default function Project() {
  ...
  useEffect(() => {
    ...
    setProjectData({
      projectOwner: (session?.user as User)?.username as session,
        ...
        >
          ...
          <div className="px-4 py-8 flex pt-20 flex-col lg:flex-row">
            <div className={`${isMobile ? "w-full mb-6" : "w-[300px]"}`}>
              <div className="w-full h-48 bg-neutral-200 dark:bg-neutral-700 rounded-xl animate-pulse"></div>
              <div className="mt-6 space-y-4">
                  ...
                  <div className="mt-2 flex space-x-2">
                    {[...Array(2)].map((_, i) => (
                      <div key={i} className="flex items-center">
                        ...
                        <div className="w-16 h-4 ml-2 bg-neutral-200 dark:bg-neutral-700 rounded animate-pulse"></div>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="mt-6">
                  ...
                  <div className="mt-2 flex flex-wrap gap-2">
                    {[...Array(6)].map((_, i) => (
                      <div
                        key={i}
                        className="w-7 h-7 rounded-full bg-neutral-200 dark:bg-neutral-700 animate-pulse"
                      ></div>
                    ))}
                  </div>
                </div>
                ...
                <div className="mt-6">
                  <div className="h-6 w-24 bg-neutral-200 dark:bg-neutral-700 rounded animate-pulse"></div>
                  <div className="mt-2 w-full h-2.5 bg-neutral-200 dark:bg-neutral-700 rounded-full animate-pulse"></div>
                  <div className="mt-2 flex flex-wrap gap-4">
                    {[...Array(4)].map((_, i) => (
                      <div key={i} className="flex items-center">
                        <div className="w-2.5 h-2.5 rounded-full bg-neutral-200 dark:bg-neutral-700 animate-pulse"></div>
                        <div className="w-12 h-4 ml-1 bg-neutral-200 dark:bg-neutral-700 rounded animate-pulse"></div>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            >
              <div className="space-y-6">
                <div>
                  ...
                  <div className="mt-4 h-4 w-full bg-neutral-200 dark:bg-neutral-700 rounded animate-pulse"></div>
                  <div className="mt-2 h-4 w-3/4 bg-neutral-200 dark:bg-neutral-700 rounded animate-pulse"></div>
                </div>

                <div className="p-4 border-2 dark:border-custom-dark-neutral rounded-md">
                  <div className="h-6 w-48 bg-neutral-200 dark:bg-neutral-700 rounded animate-pulse"></div>
                  <div className="mt-2 space-y-2">
                    {[...Array(5)].map((_, i) => (
                      <div
                        key={i}
                        className="h-3 w-full bg-neutral-200 dark:bg-neutral-700 rounded animate-pulse"
                      ></div>
                    ))}
                  </div>
                  <div className="mt-3 h-4 w-20 mx-auto bg-neutral-200 dark:bg-neutral-700 rounded animate-pulse"></div>
                </div>

                <div className="border-2 dark:border-custom-dark-neutral rounded-xl p-4">
                  <div className="h-6 w-24 bg-neutral-200 dark:bg-neutral-700 rounded animate-pulse"></div>
                  <div className="mt-4 space-y-4">
                    {[...Array(3)].map((_, i) => (
                      <div
                        key={i}
                        className="p-4 border-2 dark:border-custom-dark-neutral rounded-xl"
                      >
                        <div className="flex justify-between">
                          ...
                          <div className="flex">
                            ...
                            <div className="w-6 h-6 -ml-2 rounded-full bg-neutral-200 dark:bg-neutral-700 animate-pulse"></div>
                          </div>
                        </div>
                ...
                <div className="border border-neutral-300 dark:border-custom-dark-neutral rounded-lg p-4">
                    ...
                    {[...Array(5)].map((_, i) => (
                      ...
                      >
                        <div className="flex items-center">
                          <div className="w-8 h-8 bg-neutral-200 dark:bg-neutral-700 rounded-md animate-pulse"></div>
                          <div className="ml-3 h-4 w-48 bg-neutral-200 dark:bg-neutral-700 rounded animate-pulse"></div>
                        </div>
    ...
    try {
      ...
      if (session) {
        alert(`Request Details:
                ...
                • Avatar: ${(session?.user as User)?.image}
