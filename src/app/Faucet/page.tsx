...
export default function FaucetPage() {
  ...
  const { data: userRegisteredUsername, refetch: refetchUsername } =
    useReadContract({
      abi: faucetabi,
      address: FAUCET_CONTRACT_ADDRESS,
  ...
  const { data: isUsernameRegistered, refetch: refetchUsernameRegistered } =
    useReadContract({
      abi: faucetabi,
      address: FAUCET_CONTRACT_ADDRESS,
  ...
  const claimEther = async () => {
    ...
    if (!userStatus.canClaim) {
      setGlobalStatusMessage({
        type: "error",
        message: "You cannot claim yet. Please wait for cooldown period.",
      });
      return;
    }
      ...
      <div className="flex min-h-screen">
        ...
        >
          ...
          <div className="flex min-h-screen bg-gray-100 dark:bg-gray-950">
            {/* Side Screen */}
            <div className="hidden md:flex md:w-1/2 lg:w-2/5 items-center justify-center p-8 bg-gradient-to-br from-purple-600 to-indigo-800 text-white relative overMonad-hidden">
              ...
              <div className="relative z-10 text-center max-w-md space-y-6">
                ...
                <p className="text-lg text-white/90">
                  Get your free Ether here! We distribute 0.5 ETH to registered
                  users every 48 hours. Register your username and claim your
                  share.
                </p>
