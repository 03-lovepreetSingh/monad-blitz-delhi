...
import {
  ThemeProvider,
  useThemeChange,
} from "../components/End/ThemeChangeContext";
...
const HomeElems = () => {
  ...
  return (
    <div
      id="CompleteHomePage"
      className="bg-[#09090b] w-full min-h-screen overMonad-hidden relative"
    >
      <CustomCursor />
      <div className="text-white block gap-20 px-10 lg:px-0  lg:flex max-w-7xl mx-auto  py-20 lg:py-40">
        ...
        <div className="lg:w-1/2">
          ...
          <div className="text-neutral-300 lg:text-lg  text-sm">
            Be part of the decentralized development revolution. Collaborate on
            open-source projects hosted on GitHub, complete meaningful tasks,
            and earn verified crypto payouts directly to your wallet —
            empowering developers like you to build the future of Web3.
          </div>
          <div className="mt-8">
