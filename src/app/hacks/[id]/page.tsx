...
import { getHackathonById, getHackProjectsByHackathon } from "@/actions/hacks";
                ...
                <TabsContent value="overview" className="space-y-6 mt-6">
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Latest projects submitted to this hackathon
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      {projects.length > 0 ? (
                ...
                <TabsContent value="projects" className="space-y-6 mt-6">
                  ...
                  {projects.length > 0 ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-neutral-600 dark:text-neutral-400 mb-6">
                        This hackathon is waiting for its first project
                        submission.
                      </p>
                      {canSubmitProject() && (
                        <CreateProjectDialog
                    ...
                    <CardContent>
                      <div className="text-center py-8">
                        ...
                        <p className="text-neutral-600 dark:text-neutral-400">
                          Voting results and payment distributions will be
                          available here.
                        </p>
                      </div>
                    </CardContent>
