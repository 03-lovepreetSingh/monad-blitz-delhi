...
import { ProgressStepper } from "@/assets/components/progress-stepper";
import { ProfilePreview } from "@/assets/components/profilePreview";
import { SkillTag } from "@/assets/components/skillTag";
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-600 mb-6">
                Add your key skills (max 20). Start typing to see suggestions or
                add custom skills.
              </p>
              ...
              <div className="mb-8">
                <div className="relative">
                  <input
                    ...
                    onFocus={() =>
                      skillInput.trim() && setShowSuggestions(true)
                    }
                    onBlur={() =>
