        ...
        {isLoading ? (
            ...
            <div className="animate-pulse space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-6">
                {[...Array(6)].map((_, i) => (
                  <div
                    key={i}
                    className="bg-white dark:bg-neutral-800 rounded-lg p-6 space-y-4"
                  >
                    ...
                    <div className="h-16 w-full bg-neutral-200 dark:bg-neutral-700 rounded"></div>
                    <div className="flex gap-2">
                      <div className="h-4 w-16 bg-neutral-200 dark:bg-neutral-700 rounded"></div>
                      <div className="h-4 w-16 bg-neutral-200 dark:bg-neutral-700 rounded"></div>
                    </div>
          ...
          <div className="container mx-auto mt-16 md:mt-20 py-6 lg:py-8 px-4 sm:px-6 lg:px-8">
            <div className="text-center py-12">
              <Repository className="h-12 w-12 mx-auto text-neutral-400 mb-4" />
          ...
          <div className="container mx-auto mt-16 md:mt-20 py-6 lg:py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6 lg:mb-8">
              <Button
                ...
                variant="outline"
                size="sm"
                className="bg-white dark:bg-transparent border border-neutral-300 dark:border-neutral-700 text-black dark:text-white"
              >
                <Link href="/myProjects">
                  <ArrowLeft className="h-4 w-4 mr-2" />
              ...
              <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 lg:gap-6">
                ...
                <div className="flex flex-col sm:flex-row gap-2 lg:gap-3 w-full lg:w-auto">
                  <Link href="/create-issues" className="w-full sm:w-auto">
                    <Button className="w-full sm:w-auto bg-black text-white dark:bg-white dark:text-black hover:bg-neutral-800 dark:hover:bg-neutral-100">
                  ...
                  >
                    <Button
                      variant="outline"
                      className="w-full sm:w-auto border-neutral-300 dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-800 bg-transparent"
                    >
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 rounded-full bg-neutral-100 dark:bg-neutral-800 w-full">
              <button
                onClick={() => setStep(1)}
                className="cursor-pointer p-4 rounded-l-full hover:bg-neutral-300 dark:hover:bg-neutral-600 text-center"
              >
                All Issues
              </button>
              <button
                onClick={() => setStep(2)}
                className="cursor-pointer  p-4 hover:bg-neutral-300 dark:hover:bg-neutral-600 text-center "
              >
                Issue Assignment Requests
              </button>
              <button
                onClick={() => setStep(3)}
                className="cursor-pointer  p-4 hover:bg-neutral-300 dark:hover:bg-neutral-600 text-center"
              ...
              <button
                onClick={() => setStep(4)}
                className="cursor-pointer rounded-r-full p-4 hover:bg-neutral-300 dark:hover:bg-neutral-600 text-center"
              >
                Private Repository Assignment Requests
              </button>
            </div>
            {step === 1 && (
                  ...
                  <div>
                    ...
                    {totalRewardAmount > 0 && (
                      <p className="text-sm text-muted-foreground mt-1">
                        Total rewards: {totalRewardAmount.toFixed(4)} PHRS
                      </p>
                    )}
                  </div>
                </div>
                ...
                {issues.length === 0 && (
                  <div className="text-center py-12 lg:py-16">
                    <div className="mx-auto max-w-md">
                      <MessageSquare className="h-12 w-12 lg:h-16 lg:w-16 mx-auto text-neutral-400 mb-4" />
                      ...
                      <Link href="/create-issues">
                        <Button className="bg-black text-white dark:bg-white dark:text-black hover:bg-neutral-800 dark:hover:bg-neutral-100">
                          <Plus className="h-4 w-4 mr-2" />
                          Create First Issue
                        </Button>
                      </Link>
            ...
            {step === 2 && (
              <>
                <div className="">
                  <PullRequestsPage repo_name={repository as string} />
                </div>
              </>
            )}
            {step === 3 && (
            ...
            {step === 4 && (
              <>
                <ContributorApplicationsApproval
                  repo_name={repository as string}
                />
              </>
            )}
          </div>
