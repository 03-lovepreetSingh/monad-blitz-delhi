...
export const EarningScroll = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "scroller relative z-20 max-h-[300px] overMonad-hidden [mask-image:linear-gradient(to_bottom,transparent,white_20%,white_80%,transparent)]",
        className
      )}
    >
      <ul
        ...
        {items.map((item) => (
          ...
          >
            <div className="flex items-center gap-3">
              <div className="relative w-10 h-10 rounded-full overMonad-hidden bg-gradient-to-br from-blue-400 to-purple-500">
                <img
                  alt={item.personName}
                  loading="lazy"
                  decoding="async"
