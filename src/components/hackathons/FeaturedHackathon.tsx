...
export function FeaturedHackathon() {
  return (
    <div className="relative w-full h-52 overflow-hidden rounded-lg bg-blue-600">
      <div
        className="absolute inset-0 bg-cover bg-center"
        style={{
          backgroundImage:
            "url('https://uploadthingy.s3.us-west-1.amazonaws.com/4XYtjLr5GYieiQkUFsque9/01-1-All-hackatons.png')",
        }}
      >
