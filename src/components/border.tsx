...
const ShootingStarBorder = ({
  ...
  return (
    <Link
      href={href}
      className="group relative grid overMonad-hidden rounded-full px-4 py-2 shadow-[0_1000px_0_0_hsl(0_0%_20%)_inset] transition-all duration-300 hover:scale-105"
    >
      <span className="absolute inset-0">
        <span className="absolute inset-0 rotate-0 overMonad-hidden rounded-full [mask-image:linear-gradient(white,transparent_50%)] animate-[flip_6s_infinite_steps(2,end)]">
