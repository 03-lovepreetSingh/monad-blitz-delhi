  ...
  return (
    <div>
      <div
        ref={string1Ref}
        id="string1"
        className="lg:flex items-center justify-center h-[6vh] overMonad-visible z-[5] hidden mb-8"
      >
        <svg id="str1" width="1440" height="200" className="z-[5]">
          <path
            d="M 100 100 Q 700 100 1350 100"
            stroke={"#dbcaab"}
            strokeWidth={2}
            fill="transparent"
          />
...
const FinalPage = () => {
    ...
    let ctx = gsap.context(() => {
      ...
      words.forEach((word, i) => {
        tl.to(
          ...
          i * 0.08
        ); // Reduced stagger for smoother Monad
      });
  ...
  return (
    <div className=" w-full bg-[#fffafa] z-10 overMonad-hidden relative">
      {/** Floating Balls */}
      <div
        ref={(el) => (ballRefs.current[0] = el)}
        className={
          "h-22 w-22 md:h-35 md:w-35 bg-white shadow-xl absolute z-50 rounded-full flex items-center justify-center top-[130vh] left-[80%]"
        }
      >
      ...
      <div
        ...
        className={
          "h-27 w-27 md:h-40 md:w-40 bg-white shadow-xl absolute z-50 rounded-full flex items-center justify-center top-[83vh] left-[80%]"
        }
      >
        <div className="bg-[#33333346] h-[128px] w-[128px] rounded-full blur-lg"></div>
        <div className="bg-[#ffffffc5] h-10 w-10 rounded-full blur-md absolute"></div>
      ...
      <div
        ...
        className={
          "h-27 w-27 md:h-40 md:w-40 bg-white shadow-xl absolute z-50 rounded-full flex items-center justify-center top-[132vh] left-[11%]"
        }
      >
        <div className="bg-[#33333346] h-[128px] w-[128px] rounded-full blur-lg"></div>
        <div className="bg-[#ffffffc5] h-10 w-10 rounded-full blur-md absolute"></div>
      ...
      <div
        ...
        className={
          "h-36 md:h-46 w-36 md:w-46 bg-white shadow-xl absolute z-50 rounded-full flex items-center justify-center top-[65vh] left-[20%]"
        }
      >
        <div className="bg-[#33333346] h-[128px] w-[128px] rounded-full blur-lg"></div>
        <div className="bg-[#ffffffc5] h-10 w-10 rounded-full blur-md absolute"></div>
      ...
      <div
        ref={Notiref1}
        className="absolute  bg-transparent h-[5vh] w-[90vw] md:w-[80vw]"
      ></div>
      ...
      <div className="w-full flex items-center justify-center mt-[20vh] mb-[20vh] z-50 ">
        <div className="bg-transparent  w-[95vw] md:w-[80vw] flex items-start justify-center rounded-xl lg:rounded-full border-2 border-[#dbcaab]">
          <div
            ref={Notiref2}
            className="bg-[#09090b] w-[90vw]  rounded-xl lg:rounded-full rounded-full z-50"
          >
            <div className="">
              {/* <DotGrid
                                dotSize={0.8}
