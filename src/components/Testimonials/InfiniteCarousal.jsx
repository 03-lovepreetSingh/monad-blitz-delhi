...
export const InfiniteMovingCards = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "scroller relative z-20 max-w-[90VW] overMonad-hidden [mask-image:linear-gradient(to_right,transparent,white_20%,white_80%,transparent)]",
        className
      )}
    >
      <ul
        ...
        {items.map((item, idx) => (
          ...
          >
            <blockquote>
              <div
                aria-hidden="true"
                className="user-select-none pointer-events-none absolute -top-0.5 -left-0.5 -z-1 h-[calc(50%_+_100px)] w-[calc(30%_+_4px)]"
              ></div>
              <div className="relative z-20 mt-3 flex flex-row items-center gap-5">
                <img
                  ...
                  width={16}
                  height={16}
                  className="rounded-full border-2 h-15 w-15"
                />
