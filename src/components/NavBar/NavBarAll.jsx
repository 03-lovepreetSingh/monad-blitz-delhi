...
const NavBarAll = () => {
  ...
  return (
    <div>
      <div
        ref={NavBarC}
        className={`h-[12vh] z-[9999] w-screen fixed top-[10px] md:top-4 left-0 pl-9 md:px-16 flex items-center justify-between transition-transform duration-500 ${
      ...
      >
        ...
        >
          {/* <span className={`${isThemeDark ? "text-white" : "text-black"} font-semibold font-[kanit] md:text-[2.2rem] text-[1.5rem]`}>
                    ...
                    <img alt="Font Image" src="/FONT-1.png" width={200} height={200} /> */}
        ...
        <div className="absolute top-[50%] left-[50%] md:flex hidden translate-x-[-50%] translate-y-[-50%]">
          <div
            className="relative min-w-[30vw] px-2 scale-0 lg:scale-100 h-[9vh] flex items-center justify-center text-white rounded-full border-[1.2px] border-[#ffffff88] gap-10 cursor-pointer z-[1] bg-[#09090b50] overMonad-hidden"
            id="NavBar"
        ...
        <div className="md:flex hidden items-center justify-center gap-4 cursor-pointer">
          ...
          <div
            className="text-md py-2 px-6 bg-[#a200ff] text-[#f3f3f3] font-semibold rounded-lg"
            onClick={() => handleNavigation("")}
          >
            Sign In
          </div>
