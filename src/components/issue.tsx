...
export default function GitHubIssueList() {
  return (
    <div className="bg-[#0e0e0e] text-neutral-100 rounded-md overMonad-hidden border border-neutral-700">
      {/* Header row */}
      <div className="flex items-center p-2 bg-[#0a0a0a] border-b border-neutral-700 text-sm">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="flex items-center gap-1 text-neutral-300">
              Open
              <span className="bg-neutral-700 text-neutral-300 px-2 py-0.5 rounded-full text-xs ml-1">
                1
              </span>
            </span>
          </div>
          ...
          <span className="flex items-center gap-1 text-neutral-400">
            Closed
            <span className="bg-neutral-700 text-neutral-400 px-2 py-0.5 rounded-full text-xs ml-1">
              0
            </span>
          </span>
        </div>
        ...
        <div className="ml-auto flex items-center gap-2">
          <button className="flex items-center gap-1 px-2 py-1 text-neutral-300 hover:bg-neutral-700 rounded-md">
            Author
            <ChevronDown size={16} />
          </button>
      ...
      {/* Issue item */}
      <div className="flex items-start gap-2 p-2 hover:bg-[#0a0a09] border-b border-neutral-700 text-sm">
        <div className="pt-1">
          <input type="checkbox" className="rounded border-neutral-700" />
        </div>
        ...
        <div className="flex-grow">
          <div className="flex items-center gap-2">
            <span className="font-medium text-neutral-200">Temp</span>
