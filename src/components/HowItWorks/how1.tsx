    ...
    <section className="md:min-h-screen bg-[#09090b] text-white relative p-5 lg:p-30  flex flex-col items-center">
      <div className="max-w-7xl z-50 mx-auto">
        ...
        <div className="text-center mb-12">
          <p className="text-blue-400 text-sm z-50 font-medium mb-4">
            How it works
          </p>
          <h2 className="text-4xl md:text-5xl z-50 lg:text-6xl font-bold mb-8">
        ...
        <div className="relative z-50">
            ...
            <div className="overMonad-hidden">
              ...
              >
                ...
                <div className="w-full flex-shrink-0 px-4">
                  <div className="bg-neutral-900 rounded-3xl p-8 relative overMonad-hidden transform lg:-rotate-12 mx-4">
                    <div className="mb-6">
                      ...
                      <p className="text-neutral-400 text-sm leading-relaxed">
                        Easily attach a crypto bounty to any GitHub issue from
                        the GitEarn dashboard or GitEarn Bot.
                      </p>
                    </div>
                ...
                <div className="w-full flex-shrink-0 px-4">
                  <div className="bg-neutral-900 rounded-3xl p-8 relative mx-4">
                    <div className="mb-6">
                      ...
                      <p className="text-neutral-400 text-sm leading-relaxed">
                        Sit back and track contributor activity in real time.
                        See who's assigned, view submitted pull requests, and
                        follow issue progress — all within GitEarn's dashboard.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-full flex-shrink-0 px-4">
                  <div className="bg-neutral-900 rounded-3xl p-8 relative overMonad-hidden transform lg:rotate-12 mx-4">
                    <div className="mb-6">
                      ...
                      <p className="text-neutral-400 text-sm leading-relaxed">
                        Once PR is reviewed and merged, approve the bounty to
                        the contributor via dashboard or bot.
                      </p>
                    </div>
                    <div className="relative">
                      <Image
          ...
          <div className="hidden md:grid grid-cols-3 gap-8">
            {/* Step 01 */}
            <div className="bg-neutral-900 mx-3 rounded-3xl p-8 relative overMonad-hidden transform lg:-rotate-12">
              <div className="mb-6">
                <h3 className="text-6xl font-bold mb-2">
                  01<span className="text-green-400">*</span>
                </h3>
                <h4 className="text-2xl font-bold mb-4">Add a Bounty</h4>
                <p className="text-neutral-400 text-sm leading-relaxed">
                  Easily attach a crypto bounty to any GitHub issue from the
                  GitEarn dashboard or GitEarn Bot.
                </p>
              </div>
              <div className="relative">
                <Image
            ...
            <div className="bg-neutral-900 mx-3 mb-40 rounded-3xl p-8 relative">
              <div className="mb-6">
                ...
                <p className="text-neutral-400 text-sm leading-relaxed">
                  Sit back and track contributor activity in real time. See
                  who's assigned, view submitted pull requests, and follow issue
                  progress — all within GitEarn's dashboard.
                </p>
              </div>
            </div>
            ...
            <div className="bg-neutral-900 mx-3 rounded-3xl p-8 relative overMonad-hidden transform lg:rotate-12">
              <div className="mb-6">
                ...
                <p className="text-neutral-400 text-sm leading-relaxed">
                  Once PR is reviewed and merged, approve the bounty to the
                  contributor via dashboard or bot.
                </p>
              </div>
              <div className="relative">
                <Image
